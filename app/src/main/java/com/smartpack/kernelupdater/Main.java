...
import com.smartpack.kernelupdater.Services.BackgroundAutoCheckService;
...
public class Main extends ActionBarActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void showAboutDialog() {
        ...
        SpannableString content = new SpannableString("Donate to me");
        ...
        text4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(Keys.DONATE_ME));
